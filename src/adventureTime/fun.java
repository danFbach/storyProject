			...
			if(yesNo.matches("yes")){
				...
				switch(planet){
					...
					if(jupiterNum == 1){
						...
						break;
						}else System.out.println("Really? You can't count to two " + playerName + "?");break;
					}else System.out.println("Really? You can't count to three " + playerName + "?");break;
					
					default:
					System.out.println("You're a terrible speller.");
					break;
				}
			}
